...
const Sign = () => {
  return (
    <div class=" w-full h-screen  bg-darkBlue p-6 font-PTSans">
      <section class="absolute top-1/2 left-1/2 mx-auto max-w-sm -translate-x-1/2 -translate-y-1/2 transform space-y-4 text-center">
        ...
        <footer>
          <div class="grid grid-cols-2 gap-4">
            <button className="btn bg-facebook text-superwhite font-PTSans rounded-lg">
              <FontAwesomeIcon icon={faFacebookF} className="mr-2" />
              Facebook
            </button>
            <button className="btn bg-google text-superwhite font-PTSans rounded-lg">
