...
CREATE TABLE "new_sessions" (
    ...
    CONSTRAINT "sessions_users_id_fkey" FOREIGN KEY ("users_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_accounts" (
    ...
    "oauth_token" TEXT,
    CONSTRAINT "accounts_users_id_fkey" FOREIGN KEY ("users_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
