...
CREATE TABLE "new_Products" (
    ...
    "authorId" TEXT,
    CONSTRAINT "Products_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "user" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Products" ("authorId", "content", "id", "published", "title") SELECT "authorId", "content", "id", "published", "title" FROM "Products";
DROP TABLE "Products";
